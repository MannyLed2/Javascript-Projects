 ...
 function glowBoard(pos) {
     ...
     for (var i=0; i<squares.length;i++) {
         if (i == index0) {
             ...
             setTimeout(function() {bg3.style.backgroundColor = 'rgb(244,179,235)';}, 600);
...
function animateO(selected) {
    selected.style.transform = (selected.style.transform == "translateY(-100%)" || null) ? "trnaslateY(0)" : "trnaslateY(-100%)";
}
